...
class BookServiceTest @Autowired constructor(
  ...
  @Test
  @DisplayName("countLoanedBookTest")
  fun countLoanedBookTest() {
    // given
    val savedUser = userRepository.save(User("snoopy", null))
    userLoanHistoryRepository.saveAll(
      listOf(
        UserLoanHistory.fixture(savedUser, "Harry potter"),
        UserLoanHistory.fixture(savedUser, "Harry potter2", UserLoanStatus.RETURNED),
        UserLoanHistory.fixture(savedUser, "Harry potter3", UserLoanStatus.RETURNED),
      )
    )
  ...
  @Test
  @DisplayName("getBookStatisticsTest")
